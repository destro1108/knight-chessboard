...
const Box = ({ variant, isSelected, onClick }: BoxPropTypes) => {
  return (
    <button
      type="button"
      className={`w-16 h-16 flex border-none outline-none focus:outline-none ${
        variant === "black"
          ? "bg-black"
          : variant === "white"
          ? "bg-white"
